...
export declare class UsersController {
    ...
    findByWallet(address: string): Promise<import("./schemas/user.schema").User>;
    update(id: string, updateUserDto: UpdateUserDto): Promise<import("./schemas/user.schema").User>;
    remove(id: string): Promise<void>;
    addFavorite(id: string, eventId: string): Promise<import("./schemas/user.schema").User>;
    removeFavorite(id: string, eventId: string): Promise<import("./schemas/user.schema").User>;
}
